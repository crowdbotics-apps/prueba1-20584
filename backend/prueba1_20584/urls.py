"""prueba1_20584 URL Configuration
...
admin.site.site_title = "Prueba1 Admin Portal"
admin.site.index_title = "Prueba1 Admin"

# swagger
api_info = openapi.Info(
    title="Prueba1 API",
    default_version="v1",
    description="API documentation for Prueba1 App",
)
